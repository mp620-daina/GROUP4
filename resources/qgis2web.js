...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 13,
        minZoom: 7,
        extent: [483940.660931, 9248569.625633, 500209.948668, 9257700.946588],
        projection: new ol.proj.Projection({
            code: 'EPSG:32737',
            //extent: [489821.265239, 9248787.038037, 494329.344360, 9257483.534184],
            units: 'm'
        })
    })
});
...
map.getView().fit([483940.660931, 9248569.625633, 500209.948668, 9257700.946588], map.getSize());
